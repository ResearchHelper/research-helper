...
function offsetTransform(rect: Rect, canvasWrapper: HTMLElement) {
  let ost = computePageOffset(canvasWrapper);
...
function computePageOffset(canvasWrapper: HTMLElement): Rect {
